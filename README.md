...
Current version: **4.3.4** (originating from upstream HttpClient 4.3.4 version)
...
This repository version will publish the library under namespace `cz.msebera.android:httpclient:4.3.4`
...
```gradle
dependencies {
  compile "cz.msebera.android:httpclient:4.3.4"
}
```
